...
public class Pitch implements Comparable<Pitch> {
     ...
     * @return by how many half-steps the pitch is altered up (positive value) 
     ...
     * @return the <a href="http://en.wikipedia.org/wiki/Pitch_class">pitch class</a> of this Pitch.
     */
    ...
    /**
     * Compare this <code>Pitch</code> for equality with <code>Object o</code>.
     * Two objects of class <code>Pitch</code> are equal if they have the same '
     * base letter, alterations (sharps or flats), and same octave. Pitches 
     * that are enharmonically the same but spelt differently are not equal. 
     * For example, <code>C#4 != Db4</code>.
     * @param o Object against which this is compared for equality.
     * @return true if Object o is of class Pitch and has the same, 
     * pitch base, alterations, and octave as this.
     */
    @Override
