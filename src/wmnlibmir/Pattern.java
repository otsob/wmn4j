...
public interface Pattern {
	 ...
	 * 
	 * @param other
	 *            the <code>Pattern</code> this is compared against for equality
	 ...
	 * 
	 * @param other
	 *            the <code>Pattern</code> against which this is compared for pitch
	 *            equality.
	 ...
	 * 
	 * @param other
	 *            the <code>Pattern</code> against which this is compared for
	 ...
	 * 
	 * @param other
	 *            the <code>Pattern</code> against which this is compared for rhythm
	 *            equality.
	 ...
	 * 
	 * @param other
	 *            the <code>Pattern</code> against which this is compared for onset
	 *            equality.
