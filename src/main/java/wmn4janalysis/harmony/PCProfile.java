...
import wmn4jnotation.noteobjects.PitchClass;
...
public class PCProfile {
	...
	public interface Weighter {
		 ...
		 * 
		 * @param note
		 *            note for which weight is calculated.
	 ...
	 * 
	 * @param weighter
	 *            used for computing the value of a note when the note is added to
	 *            this profile.
	 */
	 ...
	 * 
	 * @param pc
	 *            the pitch class for the bin whose value is set.
	 * @param value
	 ...
	 * 
	 * @param durational
	 *            durational object to be added to this profile.
	 */
	 ...
	 * 
	 * @param chord
	 *            chord whose pitch classes are added to profile.
	 */
	 ...
	 * 
	 * @param note
	 *            the value is added to the bin corresponding to the pitch class of
	 *            this note.
	 */
	...
	/**
	 * @param pc
	 *            pitch class for which to get the value.
	 ...
	 * 
	 * @param a
	 *            Profile for computing correlation.
	 * @param b
	 *            Profile for computing correlation.
	 ...
	 * 
	 * @param a
	 *            Profile for computing Euclidean distance.
	 * @param b
	 *            Profile for computing Euclidean distance.
