...
import wmnkitnotation.TimeSignatures;
...
public class MusicXmlDomReaderTest {
    ...
    public void testReadScoreWithSingleNote() {
        ...
        assertEquals(Measure.Barline.SINGLE, measure.getBarline());
    ...
    public void testReadScoreWithOneStaff() {
        ...
        assertEquals(Measure.Barline.SINGLE, measureOne.getBarline());
        ...
        assertEquals(Measure.Barline.FINAL, measureTwo.getBarline());
    ...
    public void testReadScoreWithMultipleStaves() {
        ...
        assertEquals(Measure.Barline.SINGLE, staffOneMeasureOne.getBarline());
        ...
        assertEquals(Measure.Barline.FINAL, staffOneMeasureTwo.getBarline());
        ...
        assertEquals(Measure.Barline.SINGLE, staffTwoMeasureOne.getBarline());
        ...
        assertEquals(Measure.Barline.FINAL, staffTwoMeasureTwo.getBarline());
